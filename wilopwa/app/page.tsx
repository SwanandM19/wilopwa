export default function Home() {
  return (
            ...
            <div className="locationRetargeting" id="location-off-canvas-template" style={{ display: 'none' }}>
                <div className="locationRetargeting__wrapper">
                    ...
                    <a className="locationRetargeting__overview">
                        <img src="" className="locationRetargeting__flag" />
    ...
    <denser-chatbot><template data-shadowrootmode="open">
            <div className="light">
                <style>{`
                    ...
                    *,
                    ...
                    .shadow-\\[rgba\\(7\\2c _65\\2c _210\\2c _0\\.1\\)_0px_9px_30px\\] {
                        --tw-shadow: rgba(7, 65, 210, .1) 0px 9px 30px;
                    ...
                    .group:hover .group-hover\\:shadow-\\[rgba\\(7\\2c _65\\2c _210\\2c _0\\.1\\)_0px_12px_40px\\] {
                        --tw-shadow: rgba(7, 65, 210, .1) 0px 12px 40px;
                ...
                `}</style>
                <div className="fixed z-[42424242] w-[360px]" style={{ right: '20px', bottom: '92px' }}>
                    <div className="relative flex flex-col items-end gap-4 pt-6 group cursor-pointer"><button
                            className="absolute top-0 right-0 transition-all duration-300 text-neutral-500 hover:text-neutral-400"><svg
                        ...
                        <p
                            className="px-4 py-3 rounded-lg text-sm text-neutral-900 bg-white dark:bg-neutral-900 dark:text-white shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] group-hover:shadow-[rgba(7,_65,_210,_0.1)_0px_12px_40px] transition-shadow duration-300">
                            How can I help you</p>
                    </div>
                </div><button data-part="button" className="
        ...
        animate-fade-in
        w-12 h-12
      " style={{ zIndex: '42424242', backgroundColor: 'white', right: '20px', bottom: '20px', display: 'flex' }}><img alt="Logo"
                        src="https://boticons.denser.ai/icon/chatbot_i0ir1wimccf9crolldbva.png?v=1781514380603" className="
            object-fit absolute
        ...
        " style={{ fill: 'black' }}>
                ...
                <div data-part="bot" className="fixed overflow-hidden flex flex-col opacity-0 pointer-events-none"
                    style={{ transition: 'transform 200ms cubic-bezier(0, 1.2, 1, 1), opacity 150ms ease-out', zIndex: '9999', height: '100dvh', transformOrigin: 'center bottom', transform: 'scale3d(0, 0, 1)', boxShadow: 'none', inset: '0px', maxHeight: '100dvh', width: '100%', borderRadius: '0px' }}>
                    <iframe loading="lazy" title="Denser Chatbot" scrolling="no" allow="microphone"
                        src="https://denser.ai/u/embed/chatbot_i0ir1wimccf9crolldbva?in-widget=true"
                        className="w-full flex-1"></iframe></div>
            </div>
        </template><a href="https://denser.ai">denser.ai</a></denser-chatbot>
